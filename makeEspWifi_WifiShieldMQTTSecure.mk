...
LIBS = $(LIBARAIES_DIR)/OpenBCI_Wifi $(ESP_LIBS)/Wire $(ESP_LIBS)/GDBStub $(ESP_LIBS)/ESP8266WiFi  $(ESP_LIBS)/DNSServer $(ESP_LIBS)/ESP8266WebServer $(ESP_LIBS)/SPISlave $(LIBARAIES_DIR)/ArduinoJson $(ESP_LIBS)/ESP8266mDNS $(LIBARAIES_DIR)/PubSubClient $(LIBARAIES_DIR)/Time $(LIBARAIES_DIR)/WiFiManager $(ESP_LIBS)/ESP8266HTTPUpdateServer
